...
w Polsce. Ciągle używa się radia FM (ze wstawkami DCS/CTCSS) do komunikacji
lokalnej: Straż i kolejarze używają analogowej FM. Na morzu FM również
jest powszechne, a do dalszych połączeń używa się tam regularnie radia KF.
Lotnictwo używa modulacji AM w zakresie fal ultrakrótkich.

Pomimo że nadal istnieje radio w formie odbieranej przez mojego dziadka -
...
kraju znajdują niewielu odbiorców.
...
Youtube. Jednak magia odbioru sygnału jakiejś odległej stacji radiowej nadal
...
wyłącznie nasłuchowi: [swling.om](https://swling.com/).
