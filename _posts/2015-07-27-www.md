...
3. [Jekyll variables](http://jekyllrb.com/docs/variables/)
4. [Wikipedia on YAML](https://en.wikipedia.org/wiki/YAML)
5. [ArchLinux Wiki on Jekyll](https://wiki.archlinux.org/index.php/Jekyll)
6. [Liquid for Designers](https://github.com/Shopify/liquid/wiki/Liquid-for-Designers)
