...
## Limited Support
Markdown is pretty limited and pandoc has some extra extension to cover special
features as <sub>subscript</sub> and <sup>superscript</sup>. However it may
be easily addressed by directly using HTML tags in markdown itself. For the
super/subscript you just use &lt;sub&gt; &lt;sup&gt;
